...
from booleano.parser import Grallar, EvaluableParseManager, SymbolTable, Bind
...
class DataSource:
  ...
  def create_grallar(self):
    ...
    grallar = Grallar(**tokens)
    self.parse_manager = EvaluableParseManager(root_table, grallar)
