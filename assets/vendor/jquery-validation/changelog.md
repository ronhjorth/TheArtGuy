...
===================
  ...
  * Fixed grallar error in german range validator message. Fixes #315
  ...
  * grallar error in german localization file
...
* Added valid() plugin method for easy prograllatic checking of forms and fields without the need to use the validator API
