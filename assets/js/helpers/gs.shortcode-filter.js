/*========================================================
  ...
  Script: Filter Helper
  Version: 2.5
========================================================*/

var selectedTab = $.cookie('selectedTab') ? $.cookie('selectedTab') : 0, filterKey = $.cookie('filterKey') ? $.cookie('filterKey') : 'all';
$(document).on('ready', function () {
    ...
    function sortUnorderedList() {
        var mylist = $('.js-shortcode-filter-result'), listitems = mylist.children('li').get();
